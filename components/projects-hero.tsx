...
const PROJECTS_IMAGES = [
  {
    ...
    alt: "Digital product development and software projects",
    pos: "object-[center_42%]",
  },
  {
    src: "/images/corex-hero.jpg",
    alt: "Technology project delivery and innovation",
    pos: "object-[center_35%]",
  },
  {
    src: "/images/corex-hero-2.jpg",
    alt: "Team building powerful digital solutions",
    pos: "object-[center_38%]",
  },
  {
    src: "/images/hero-bg.jpg",
    alt: "Enterprise software project showcase",
...
export function ProjectsHero() {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      setIndex((i) => (i + 1) % PROJECTS_IMAGES.length);
    }, 4500);
    ...
    >
      <div className="absolute inset-0">
        <AnimatePresence mode="popLayout">
          ...
          >
            <Image
              src={PROJECTS_IMAGES[index].src}
              alt={PROJECTS_IMAGES[index].alt}
              fill
              priority={index === 0}
              sizes="100vw"
              className={`object-cover ${PROJECTS_IMAGES[index].pos}`}
            />
          </motion.div>
        </AnimatePresence>
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 lg:px-10 flex items-center min-h-[52vh] md:min-h-[56vh] lg:min-h-[60vh] py-10 md:py-14 lg:py-12">
        <div className="w-full max-w-[680px] xl:max-w-[700px]">
          ...
          >
            ...
            <span className="hidden sm:inline text-[10px] tracking-[0.12em] uppercase text-white/50">Web · Mobile · Enterprise</span>
          </motion.div>
          ...
          >
            Our Projects
            <br />
            <span className="font-light tracking-[-0.04em] text-white/95">Transforming ideas</span>
            <br />
          ...
          >
            Explore how we transform ambitious ideas into reliable, scalable software — from enterprise platforms to
            customer-focused digital products built for real-world impact.
          </motion.p>
